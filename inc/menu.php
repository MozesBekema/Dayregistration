<header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
        ...
        <nav class="mdl-navigation mdl-layout--large-screen-only">
            <a href="login.php"><button class="mdl-button mdl-js-button mdl-js-ripple-effect dialog-button buttonRed">Login</button></a>
        </nav>
    </div>
</header>
<div class="mdl-layout__drawer"> <span class="mdl-layout-title"><a href="index.php"><img src="img/logo.png"></a>Day Registration</span>
    <nav class="mdl-navigation mdl-js-ripple-effect">
        <a href="login.php"><button class="mdl-button mdl-js-button mdl-js-ripple-effect dialog-button buttonBlack">Login</button></a>
    </nav>
</div>
